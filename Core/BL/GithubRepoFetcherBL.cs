...
namespace Core.BL
{
    public class GithubRepoFetcherBL : IGithubRepoFetcherBL
    {
        ...
        private readonly IRepoSyncNotifier _repoSyncNotifier;
        ...
        private async Task<IEnumerable<Repo>> MakeAllPinnedReposNonCurrent()
        {
            ...
            foreach (var currentPinnedRepo in currentPinnedReposList) currentPinnedRepo.Current = false;
            var nonCurrentRepos =
        ...
        private void UpdateItemStatus(JobUpdatesStage stage, Repo repo)
        {
            ...
            _repoSyncNotifier.PushUpdate(_itemStatus, _jobStatus);
        }
